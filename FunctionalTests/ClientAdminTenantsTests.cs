namespace ci_automation_enterpriseportalui.FunctionalTests
{
    public class ClientAdminTenantsTests
    {
        ...
        //    //Validate Min:  TenantName 1 (covered in required), TenantKey 3
        //    //Auth0 Requirements for TenantKey:  Min 3 Char
        //    Thread.Sleep(2000);
        //    Actions.EnterText(CreateNewTenantPage.TenantName, "ABCD");
        //    Actions.EnterText(CreateNewTenantPage.TenantKey, "AB");
        //    Actions.ClickElement(CreateNewTenantPage.Create);
        //    //Actions.GetElementText(ToastifyNotification.ToastNotification("error")).Should().BeEquivalentTo("Please Correct Validation Errors");
        //    //Actions.GetElementCssValue(ToastifyNotification.ToastNotification("error"), 10, "background-color").Should().BeEquivalentTo("rgba(176, 0, 32, 1)");  //red
        //    //Actions.ClickElement(ToastifyNotification.CloseToast);
        //    //Actions.GetElementText(CreateNewTenantPage.TenantNameError).Should().BeEquivalentTo("Tenant Name must be between 5 and 100 characters long");
        //    //Actions.GetElementCssValue(CreateNewTenantPage.TenantNameError, 10, "color").Should().BeEquivalentTo("rgba(176, 0, 32, 1)"); //red
        //    Actions.GetElementText(CreateNewTenantPage.TenantKeyError).Should().BeEquivalentTo("The length of 'Key' must be at least 3 characters. You entered 2 characters.");
        //    Actions.GetElementCssValue(CreateNewTenantPage.TenantKeyError, 10, "color").Should().BeEquivalentTo("rgba(176, 0, 32, 1)"); //red
        ...
        //    Actions.GetElementCssValue(ToastifyNotification.ToastNotification("error"), 10, "background-color").Should().BeEquivalentTo("rgba(176, 0, 32, 1)");  //red
        //    Actions.ClickElement(ToastifyNotification.CloseToast);
        //    Actions.GetElementText(CreateNewTenantPage.TenantNameError).Should().BeEquivalentTo("Tenant Name must be between 1 and 100 characters long");
        //    Actions.GetElementCssValue(CreateNewTenantPage.TenantNameError, 10, "color").Should().BeEquivalentTo("rgba(176, 0, 32, 1)"); //red
        //    Actions.GetElementText(CreateNewTenantPage.TenantKeyError).Should().BeEquivalentTo("Tenant Key must be between 1 and 15 characters long");
        //    Actions.GetElementCssValue(CreateNewTenantPage.TenantKeyError, 10, "color").Should().BeEquivalentTo("rgba(176, 0, 32, 1)"); //red
        //    Actions.ClearText(CreateNewTenantPage.TenantName);
        //    Actions.ClearText(CreateNewTenantPage.TenantKey);
        //}
        ...
        //    //Validate Allowable Characters:  TenantKey No Special or Spaces, must not start with number
        ...
        //    Actions.GetElementAttribute(EditTenantPage.TenantName, 10, "value").Should().BeEquivalentTo("U of QA 123 -_:&");

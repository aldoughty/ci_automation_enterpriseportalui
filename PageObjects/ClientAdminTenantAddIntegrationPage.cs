namespace ci_automation_enterpriseportalui.PageObjects
{
    public static class ClientAdminTenantAddIntegrationPage
    {
        ...
        public static By Add(string integration) => By.XPath(string.Format("//div//descendant::div//descendant::h5[contains(text(), '{0}')]//following::div//descendant::div//descendant::button[contains(@class, 'integrations_add-integration-button')]", integration));
        public static By AddedStatus(string integration, string status) => By.XPath(string.Format("//div//descendant::div//descendant::h5[contains(text(), '{0}')]//following::div//descendant::div//descendant::button[contains(@class, 'integrations_add-integration-button') and contains(text(), '{1}']", integration, status));
    }
}
